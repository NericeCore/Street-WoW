...
int Master::Run()
{
	...
	sLog->outString("			 ");
 	...
 	sLog->outString(" .##....##..##.....##.##.....##.##.......##....##...##.##.. ");
 	sLog->outString(" ..######...##.....##.##.....##.########..######.....###... ");
 	sLog->outString(" __________________________________________________________ ");
 	sLog->outString("ВЫ ВЛАДЕЛЕЦ ПРИВАТ ВЕРСИИ ОДНОЙ ИЗ ЛУЧШИХ СБОРОК СЕРВЕРА WOW");
 	sLog->outString("все что вы получили было создано лично для Вас!");
 	sLog->outString("При передаче, перепродаже или распространении сборки ");
 	sLog->outString("Вы теряете статус владельца привата!");
 	sLog->outString("Совершая это вы лишаете себя всех последующих обновлений");
 	sLog->outString("Так же вы лишаетесь любого вида тех поддержки с нашей стороны");
 	sLog->outString("Цените труд тех, кто делал для Вас эту сборку!");
 	sLog->outString("			 ");
	sLog->outString("			 ");
